...
class UploadReq extends BaseReq
{
    ...
    {
        return [
            "image" => ['required', 'file', 'dimensions:min_width=115,min_height=50,max_height=5000,max_width=5000', 'max:10240', 'mimetypes:image/jpeg,image/png', 'mimes:png,jpg,jpeg'],
            'x' => ['required', 'numeric', "min:0", "max:5000"],
            'y' => ['required', 'numeric', "min:0", "max:5000"],
            'width' => ['required', 'numeric', "min:115", "max:5000"],
